        ...
        <div className="w-full max-w-4xl flex flex-col items-center">
          ...
          <div className="mb-8 text-center max-w-2xl">
            ...
            <h1 className="font-sans font-black text-[clamp(32px,5vw,52px)] tracking-[-0.03em] leading-[1.05] mb-4">
              ...
              <span className="text-primary italic font-serif font-normal">AI Automation</span> Strategy call
            </h1>
            <p className="text-sm text-muted-foreground leading-[1.7] max-w-md mx-auto">
              Tell us about your business. We'll map out exactly where AI automation can save you time and money - No code experience required - No fluff
            </p>
          </div>
