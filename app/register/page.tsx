        ...
        <div className="w-full max-w-4xl flex flex-col items-center">
          ...
          <div className="mb-8 text-center max-w-2xl">
            ...
            <p className="text-sm text-muted-foreground leading-[1.7] max-w-md mx-auto">
              Pick a time below that works best for you. We will jump on a 30-minute discovery call to map out an automation blueprint built entirely for your business.
            </p>
          </div>
