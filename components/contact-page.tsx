...
export function ContactPage({ locale }: { locale: Locale }) {
  ...
  const featureItems = [
    { icon: <IconPhone />, label: copy.features[0] },
    { icon: <IconMap />, label: copy.features[1] },
    { icon: <IconNoCode />, label: copy.features[2] },
  ]
  return (
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-32 pb-20 relative z-10">
        <div className="w-full max-w-[900px] flex flex-col items-center">
          ...
          <div className="w-full bg-card border border-border rounded-[14px] p-2 md:p-4 shadow-[0_2px_16px_rgba(20,32,26,0.06)] relative overflow-hidden min-h-[650px]">
            <iframe
              src={`https://calendly.com/matelabai26/30min?embed_domain=matelab.ai&embed_type=Inline${locale === "es" ? "&locale=es" : ""}`}
              width="100%"
              height="650px"
              frameBorder="0"
